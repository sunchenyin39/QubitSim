...
ax.plot(circuit.t_list*1E9, circuit.signal_1z)
ax.set_title("signal_1z")
ax.set_xlabel("t/ns")
ax = plt.subplot(2, 2, 2)
ax.plot(circuit.t_list*1E9, circuit.signal_2z)
ax.set_title("signal_2z")
ax.set_xlabel("t/ns")
ax = plt.subplot(2, 2, 3)
ax.plot(circuit.t_list*1E9, circuit.signal_3z)
ax.set_title("signal_3z")
ax.set_xlabel("t/ns")
plt.tight_layout()
plt.savefig(fname="DCCZ_signal.png")
# 3.Run.
circuit.run()
# 4.data process
DCCZ_matrix = np.load(circuit.npy_filename)
print("DCCZ_matrix:")
for i in range(4):
    for j in range(4):
